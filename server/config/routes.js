...
module.exports.routes = {
  ...
  'GET /api/cards/filter-by-epic/:epicId': 'cards/filter-by-epic',

  'GET /api/boards/:boardId/epics': 'epics/index',
  'POST /api/lists/:listId/epics': 'epics/create',
  'GET /api/epics/:id': 'epics/show',
  'PATCH /api/epics/:id': 'epics/update',
  'DELETE /api/epics/:id': 'epics/delete',
  'GET /api/epics/:epicId/stories': 'epics/stories',
  'GET /api/epics/:epicId/projects': 'epics/projects',
  'POST /api/epics/:epicId/link-story/:storyId': 'epics/link-story',
  'POST /api/epics/:epicId/link-project/:projectId': 'epics/link-project',
  'DELETE /api/stories/:storyId/unlink': 'epics/unlink-story',
  'DELETE /api/projects/:projectId/unlink': 'epics/unlink-project',
